"""HTTP client for the official PaddleX OCR serving endpoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test official PaddleX OCR serving.")
    parser.add_argument("--base-url", default="http://127.0.0.1:8080", help="Service base URL.")
    parser.add_argument("--endpoint", default="/ocr", help="OCR REST endpoint shown by PaddleX docs.")
